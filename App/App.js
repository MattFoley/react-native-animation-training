        ...
        {props.navigationState.routes.map((route, i) => {
          ...
          return (
            <TouchableOpacity
              ...
              <Animated.Text style={{color, ...styles.tabItemText}}>{route.title}</Animated.Text>
            </TouchableOpacity>
          );
        })}
        </View>
    ...
    return (
      <TabView
        ...
        renderScene={SceneMap({
          animatable: () => { return (<AnimatableTestView />); },
          animated: () => { return (<AnimatedTestView />); },
          lottie: () => { return (<LottieTestView />); },
          layoutAnimation: () => { return (<LayoutAnimationTestView />); }
        })}
